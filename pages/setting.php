...
echo $lang_home['lang'] . ':<br><select name="lang"><option value="' . $show_user['lang'] . '">' . $show_user['lang'] . '</option>';
    ...
    closedir ($dir); 
		...
		if (empty($current_mtheme)) {
			$current_mtheme = 'No selected skin';
		} // update lang
    ...
    echo $lang_setting['newsonpage'] . ':<br><input name="news" value="' . $page_set['newsmes'] . '" /><br />';
    echo $lang_setting['msginforumtopic'] . ':<br><input name="forumpost" value="' . $page_set['forummes'] . '" /><br />';
    echo $lang_setting['topicsinforumpp'] . ':<br><input name="forumtem" value="' . $page_set['forumtem'] . '" /><br />';
    echo $lang_setting['msgsininboxpp'] . ':<br><input name="prrivs" value="' . $page_set['privmes'] . '" /><br />'; 
