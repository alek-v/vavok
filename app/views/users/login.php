{@header}}
	...
	<div id="form_wrapper" class="form_wrapper">
		...
		<div>
			<label>{@website_language[pass]}}: <a href="{@HOMEDIR}}users/lostpassword" rel="forgot_password" class="forgot linkform">{@website_language[lostpass]}}</a></label>
		...
		<div class="bottom">
			...
			<a href="{@HOMEDIR}}users/register" rel="register" class="linkform">{@website_language[registerHere]}}</a>
			<div class="clear"></div>
		</div>
		</form>
	</div>
