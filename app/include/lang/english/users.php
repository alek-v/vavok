...
$lang_page['welcome'] = "Welcome";
$lang_page['confirmation_info'] = "To confirm your registration, you need to enter the confirmation code that has been sent to your email address.";
$lang_page['key'] = "Confirmation code";
$lang_page['actinfodel'] = "Confirm registration before logging in to the site.<br />Registration should be confirmed within 24 hours after registration.";
$lang_page['keyok'] = "Registration has been successfully confirmed, you can log into the site now";
$lang_page['keynotok'] = "Confirmation code incorrect, please check the key you entered";
$lang_page['nokey'] = "You didn't entered any confirmation code";
...
$lang_page['subscribetonews'] = "Subscribe to the site news";
$lang_page['yes'] = "Yes";
$lang_page['no'] = "No";
$lang_page['registration_already_confirmed'] =  'Registration has been already confirmed';
$lang_page['confmailsent'] = 'Confirmation mail has been sent';
$lang_page['confmailwillbesent'] = 'Confirmation mail will be sent soon';
$lang_page['too_early_to_resend'] = 'It is too early to resend confirmation email. Try again in 10 minutes.';
$lang_page['howtolostpass'] = "Write your username and email.<br />Password will be sent to you in an email";
$lang_page['newpassfromsite'] = "New login details for the site";
$lang_page['hello'] = "Hello";
$lang_page['yournewdata'] = "Your new login information required to access the site";
$lang_page['lnkforautolog'] = "Link for autologin to the site";
$lang_page['you_can_change_password'] = "You can change your password in your profile page after login";
$lang_page['passgen'] = "Password succesfully generated!<br />New password has been sent to the email address you set up in your profile";
$lang_page['wrongcaptcha'] = "Captcha solution incorrect";
$lang_page['wrongmail'] = "You have written wrong email address";
$lang_page['noneededdata'] = "You didn't complete all of the required data ";
$lang_page['delsubok'] = "You have been successfully unsubscribed from site news"; // site news subscription
$lang_page['unsubcodefail'] = "Unsubscription code invalid";
