...
$lang_admin = array(
    ...
    'you_are_changing_your_profile' => "You are changing your profile!",
    'banduration' => "Ban duration",
    'minutes' => "minutes",
    'hours' => "hours",
    'days' => "days",
    'maxbantime' => "Maximum ban time",
    'bandesc' => "Reason of the ban",
    'please_state_ban_description' => "Please enter a reason for the ban",
    'user_is_banned' => "User is banned! Account has been suspended!",
    'bandate' => "Ban date",
    'banend' => "Time until ban ends",
    'delban' => "Remove ban",
    'user_does_not_exist' => "Username does not exist",
    'no_username' => "Please enter the username",
    'noreason' => "You didn't state a reason for the ban",
    'maxbantimeare' => "Maximum ban time is",
    'nobantime' => "You didn't entered a ban duration",
    'usrdata' => "User data",
    ...
    'error_404' => "Error 404 - file does not exist",
    'other' => "Other",
    'error_401' => "Error 401 - You do not have sufficient rights to view the selected document.",
    'error_402' => "Error 402 - Unrecognised request code.",
    'error_403' => "Error 403 - Request not allowed",
    'error_406' => "Error 406 - An appropriate representation of the requested resource",
    'error_500' => "Error 500 - Internal server error",
    'error_502' => "Error 502 - inadequate response from other server",
    'noentry' => "No entry",
