...
$lang_page['welcome'] = "Добро дошли";
$lang_page['confirmation_info'] = "Да бисте потврдили регистрацију морате уписати кључ који вам је послат на адресу е-поште.";
$lang_page['key'] = "Кључ";
$lang_page['actinfodel'] = "Потврдите регистрацију пре пријављивања на сајт.<br />Регистрацију је потребно потврдити у року од 24 сата након регистрације.";
$lang_page['keyok'] = "Регистрација је успешно потврђена, сада се можете пријавити на сајт";
...
$lang_page['yes'] = "Да";
$lang_page['no'] = "Не";
$lang_page['registration_already_confirmed'] =  'Регистрација је већ била потврђена';
$lang_page['confmailsent'] = 'Порука е-поште за потврду регистрације је послата';
$lang_page['confmailwillbesent'] = 'Порука е-поште за потврду регистрације ће ускоро бити послата';
$lang_page['too_early_to_resend'] = 'Прерано је за поновно слање е-поште за потврду регистрације. Покушајте поново за 10 минута.';
$lang_page['howtolostpass'] = "Упишите ваше корисничко име и адресу е-поште из профила.<br />Шифра ће вам бити послата на адресу е-поште";
$lang_page['newpassfromsite'] = "Нови подаци за приступ сајту";
$lang_page['hello'] = "Здраво";
$lang_page['yournewdata'] = "Ваши нови подаци за приступ сајту";
$lang_page['lnkforautolog'] = "Линк за аутоматско пријављивање на сајт";
$lang_page['you_can_change_password'] = "Шифру можете променити у профилу након пријављивања на сајт";
$lang_page['passgen'] = "Шифра успешно генерисана!<br />Нова шифра вам је послата на адресу е-поште из вашег профила";
$lang_page['wrongcaptcha'] = "Уписали сте погрешан код за проверу";
$lang_page['wrongmail'] = "Уписали сте погрешну адресу е-поште";
$lang_page['noneededdata'] = "Нисте уписали неопходне податке";
$lang_page['delsubok'] = "Успешно сте се одјавили"; // site news subscription
$lang_page['unsubcodefail'] = "Код за одјаву неправилан";
$lang_page['unsubfail'] = "Одјава са новости неуспешна";
