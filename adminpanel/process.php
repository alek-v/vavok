...
if ($vavok->post_and_get('action') == "addbw" && $_SESSION['permissions'] == 101 && $_POST['slovo'] != '') {
...
if ($vavok->post_and_get('action') == "delerid" && !empty($_GET['err']) && ($_SESSION['permissions'] == 101 or $_SESSION['permissions'] == 102)) {
