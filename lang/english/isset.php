...
// user isset
"quarantine" => 'Quarantine is on! New users cannot write comments and messages ' . round($config["quarantine"] / 3600) . ' hours after registration',
...
// forms
$formsArray = array(
"antiflood" =>  'Antiflood! Please wait ' . (int)$config["floodTime"] . ' seconds!',
